...
import { QAMISCoordinatorEndorsement, IM } from "@prisma/client";
import axios from "axios";

export interface useQAMISCoordinatorEndorsementParams {
  id: string;
}
export default function useQAMISCoordinatorEndorsement({ id }: useQAMISCoordinatorEndorsementParams) {
