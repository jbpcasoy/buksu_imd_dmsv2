...
export default function useReturnedCITLRevisionSuggestionItem({
  id,
}: useReturnedCITLRevisionSuggestionItemParams) {
  const [state, setState] =
    useState<ReturnedCITLRevisionSuggestionItem | null>();
