...
import {
    ...
    return (
      <div>
        <IMERCSuggestionActionTaken
          ...
          contentSpecialistName="Mellou P. Tiu"
          iDDCoordinatorName="Maricel D. Inovejas"
        />
      </div>
    );
  }
  ...
  interface IMERCSuggestionActionTakenProps {
    ...
    contentSpecialistRatings: ("VM" | "M" | "JE" | "NM" | "NAA")[][];
    contentEditorRatings: ("VM" | "M" | "JE" | "NM" | "NAA")[][];
    iDDSpecialistRatings: ("VM" | "M" | "JE" | "NM" | "NAA")[][];
