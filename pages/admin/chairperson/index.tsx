      ...
      <div className="flex flex-col h-full space-y-4">
        <div className="flex justify-between p-1">
          <div className="flex justify-center items-end space-x-4">
            <div className="flex justify-center items-center p-3 bg-palette_white rounded-lg space-x-2">
              <svg
              ...
              <h2 className="font-bold">Chairperson</h2>
            </div>
        ...
        <div className="h-full border-palette_grey flex flex-col flex-1 bg-palette_white rounded-2xl p-4">
...
interface ChairpersonItemProps {
  chairperson: Chairperson;
}
...
function ChairpersonItem({ chairperson }: ChairpersonItemProps) {
  ...
  const activateHandler = async () => {
    ...
    return axios
      ...
      .then(() => {
        addSnackbar("Chairperson has been activated successfully");
      })
      .catch((error) => {
        addSnackbar(
  ...
  const deactivateHandler = async () => {
    return axios
      ...
      .then(() => {
        addSnackbar("Chairperson has been deactivated successfully");
      })
      .catch((error) => {
        addSnackbar(
          error?.response?.data?.error?.message ??
    ...
    <tr key={chairperson.id} className="border-b">
      ...
      <td className="py-1 flex justify-center items-center space-x-1">
        <input
          ...
          checked={Boolean(activeChairperson)}
