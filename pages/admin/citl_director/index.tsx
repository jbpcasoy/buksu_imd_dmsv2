      ...
      <div className="flex flex-col space-y-4 h-full">
        <div className="flex justify-between p-1">
          <div className="flex justify-center items-end space-x-4">
            <div className="flex space-x-2 justify-center items-center p-3 bg-palette_white rounded-lg">
              <svg
              ...
              <h2 className="font-bold">CITL Director</h2>
            </div>
        ...
        <div className="h-full flex-1 flex flex-col bg-palette_white rounded-2xl p-4">
