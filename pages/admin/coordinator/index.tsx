      ...
      <div className="flex flex-col space-y-4 h-full">
        <div className="flex justify-between p-1">
          <div className="flex justify-center items-end space-x-4">
            <div className="space-x-2 p-3 bg-palette_white flex justify-center items-center rounded-lg">
              <svg
              ...
              <h2 className="font-bold">Coordinator</h2>
            </div>
        ...
        <div className="h-full bg-palette_white rounded-2xl p-4 flex flex-col flex-1">
  ...
  return (
    <tr key={coordinator.id} className="border-b">
      ...
      <td className="py-1 flex justify-center items-center space-x-1">
        ...
        <>
          <button
            className="rounded bg-palette_blue h-7 w-7 flex justify-center items-center"
            onClick={handleOpen}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
  ...
  return (
    <div className="flex bg-palette_white">
      ...
      <input
        ...
        placeholder="Search"
        value={filterValue}
        className="bg-inherit border-b py-1 rounded-e-lg focus:border-palette_grey focus:ring-palette_grey"
  ...
  return (
    <div className="flex">
      <select
        onChange={handleFieldChange}
        value={selectedField}
        className="py-1 rounded-s-lg bg-inherit focus:border-palette_grey focus:ring-palette_grey bg-palette_white"
      >
        <option value="name">Name</option>
        <option value="departmentName">Department</option>
        <option value="collegeName">College</option>
      ...
      <select
        ...
        value={sortDirection}
        className="py-1 rounded-e-lg bg-inherit focus:border-palette_grey focus:ring-palette_grey bg-palette_white"
      >
