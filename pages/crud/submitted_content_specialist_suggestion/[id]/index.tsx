...
export default function SubmittedContentSpecialistSuggestionPage() {
  ...
  const submittedContentSpecialistSuggestion = useSubmittedContentSpecialistSuggestion({
  ...
  const deleteHandler = () => {
    ...
    axios
      ...
      .then(() => {
        alert("SubmittedContentSpecialistSuggestion has been deleted successfully");
      })
      .catch((error) => {
  ...
  return (
    <CrudLayout>
      ...
      <p>
        createdAt:{" "}
        {new Date(submittedContentSpecialistSuggestion.createdAt).toLocaleString()}
      </p>
      <p>
        updatedAt:{" "}
        {new Date(submittedContentSpecialistSuggestion.updatedAt).toLocaleString()}
      </p>
      <p>
