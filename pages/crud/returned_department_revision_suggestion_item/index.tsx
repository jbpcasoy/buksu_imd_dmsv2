...
export default function ReturnedDepartmentRevisionSuggestionItemsPage() {
  ...
  const { returnedDepartmentRevisionSuggestionItems, count } = useReturnedDepartmentRevisionSuggestionItems(state);
    ...
    <CrudLayout>
      ...
      <div>
        <table className='table-auto w-full'>
          ...
          <tbody>
            {returnedDepartmentRevisionSuggestionItems.map((returnedDepartmentRevisionSuggestionItem) => {
              return (
                <tr key={returnedDepartmentRevisionSuggestionItem.id}>
                  <td>{returnedDepartmentRevisionSuggestionItem.id}</td>
                  <td>
                    {new Date(returnedDepartmentRevisionSuggestionItem.createdAt).toLocaleString()}
                  </td>
                  <td>
                    {new Date(returnedDepartmentRevisionSuggestionItem.updatedAt).toLocaleString()}
                  </td>
                  <td>
                    <Link
