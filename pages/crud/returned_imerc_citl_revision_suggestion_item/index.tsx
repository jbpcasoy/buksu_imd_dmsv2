...
export default function ReturnedIMERCCITLRevisionSuggestionItemsPage() {
  ...
  const { returnedIMERCCITLRevisionSuggestionItems, count } = useReturnedIMERCCITLRevisionSuggestionItems(state);
    ...
    <CrudLayout>
      ...
      <div>
        <table className='table-auto w-full'>
          ...
          <tbody>
            {returnedIMERCCITLRevisionSuggestionItems.map((returnedIMERCCITLRevisionSuggestionItem) => {
              return (
                <tr key={returnedIMERCCITLRevisionSuggestionItem.id}>
                  <td>{returnedIMERCCITLRevisionSuggestionItem.id}</td>
                  <td>
                    {new Date(returnedIMERCCITLRevisionSuggestionItem.createdAt).toLocaleString()}
                  </td>
                  <td>
                    {new Date(returnedIMERCCITLRevisionSuggestionItem.updatedAt).toLocaleString()}
                  </td>
                  <td>
                    <Link
