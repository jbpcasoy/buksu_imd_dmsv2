                    ...
                    <div className="flex flex-row space-x-2">
                      <div className="text-sm">
                        ...
                        <input
                          ...
                          className="w-full p-2 rounded-lg border border-palette_light_grey disabled:border-opacity-80 text-sm focus:border-palette_light_grey focus:outline-0 focus:ring-0 "
                        />
                      </div>
                      <div className="text-sm">
