...
import { IDDSpecialistSuggestionItem, SubmittedIDDSpecialistSuggestion } from "@prisma/client";
...
function UserInformation({submittedIDDSpecialistSuggestion}: UserInformationProps) {
